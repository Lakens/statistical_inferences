```{r, include = FALSE}
knitr::opts_chunk$set(error = FALSE, warning = FALSE, message = FALSE, fig.align  = 'center', out.width  = '100%')
```
...
```{r preregcheclist, fig.margin=FALSE, echo=FALSE, fig.cap="Screenshot Table 1, summarizing the checklist for preregistrations by Wicherts et al., 2016."}
...
```{r imdbrating, out.width  = '40%', echo=FALSE, fig.cap="Screenshot of a IMDB and metacritic rating."}
