...
knitr::kable(table_pow_justifications, caption = "Overview of possible justifications for the sample size in a study.")
...
knitr::kable(table_pow_justifications, caption = "Overview of possible ways to evaluate which effect sizes are interesting.")
...
knitr::kable(table_pow_justifications, caption = "Overview of recommendations when reporting a sample size justification based on resource constraints.")
...
```{r, power-2, echo=FALSE, fig.cap="Power curve for an independent *t* test with an effect of *d* = 0.5 and $\\alpha$ = 0.05 as a function of the sample size."}
N <- 50
d <- 0.5
p_upper <- 0.05
...
```{r, echo = FALSE, power-3, fig.cap="Null (*d* = 0, grey dashed line) and alternative (*d* = 0.5, solid black line) hypothesis, with $\\alpha$ = 0.05 and n = 80 per group."}
...
knitr::kable(table_pow_justifications, caption = "Overview of recommendations when reporting an a-priori power analysis.")
```
...
```{r gcrit2, echo = FALSE, fig.cap="The critical correlation of a test based on a total sample size of 30 and $\\alpha$ = 0.05 calculated in G*Power."}
...
knitr::kable(table_pow_justifications, caption = "Overview of recommendations when justifying the use of a meta-analytic effect size estimate for a power analysis.")
...
knitr::kable(table_pow_justifications, caption = "Overview of recommendations when justifying the use of an effect size estimate from a single study.")
```
...
```{r gsens0, echo = FALSE, fig.cap="Sensitivity power analysis in G*Power software."}
...
```{r gsens1, echo=FALSE, fig.cap="Plot of the effect size against the desired power when n = 15 per group and alpha = 0.05."}
...
```{r gpowcompromise, echo = FALSE, fig.cap="Compromise power analysis in G*Power."}
...
knitr::kable(table_pow_justifications, caption = "Overview of recommendations when justifying error rates based on a compromise power analysis.")
```
