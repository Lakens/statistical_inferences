...
```{r meta-sim-rand, echo = FALSE, fig.cap="Simulated studies under a random effects model"}
set.seed(199)
...
```{r meta-sim-fixed, echo = FALSE, fig.cap="Simulated studies under a fixed effect model"}
