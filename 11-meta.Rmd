...
```{r freiman1978, echo=FALSE, out.width  = '100%', fig.height = 10, fig.cap="First version of a forest plot by Freiman and colleagues, 1978 (image from https://www.jameslindlibrary.org/freiman-ja-chalmers-tc-smith-h-kuebler-rr-1978/)"}
