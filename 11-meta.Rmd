...
```{r plot-hist-iq-1, echo = TRUE, fig.cap="(ref:plot-hist-iq-1lab)"}
library(ggplot2)
...
FOR ME, RUNNING THE ABOVE CODE RETURNS THE FOLLOWING ERROR: Error in structure(list(fill = fill, colour = colour, size = size, linetype = linetype,  : 
  object 'backgroundcolor' not found
...
```{r plot-hist-iq-2, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:plot-hist-iq-2lab)"}
set.seed(519)
...
```{r plot-hist-iq-3, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:plot-hist-iq-3lab)"}
...
```{r plot-group1, warning=FALSE, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:plot-group1lab)"}
# Set color palette
...
```{r plot-group2, warning=FALSE, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:plot-group2lab)"}
# Set color palette
cbbPalette <- c("#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
...
```{r plotgroup3, warning=FALSE, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:plotgroup3lab)"}
# Set color palette
cbbPalette <- c("#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
...
```{r, plot-cor1, warning=FALSE, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:plot-cor1lab)"}
set.seed(4130)
...
```{r, plot-cor2, warning=FALSE, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:plot-cor2lab)"}
set.seed(4130)
...
```{r metaforest, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:metaforestlab)"}
par(mar=c(5,4,0,2))
...
```{r meta-sim, echo = TRUE, fig.cap="(ref:meta-simlab)"}
set.seed(94)
...
table_print <- knitr::kable(table_rec, caption = "Six practical recommendations to improve the quality and reproducibility of meta-analyses.")
