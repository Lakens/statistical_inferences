...
```{r, echo = FALSE, tab.cap = "Summary statistics for our dataset."}
sum_table <- summarise(group_by(df_long, daniel_kyra),
                       mean = mean(rating), sd = sd(rating), n = n(), 
                       .groups = 'drop')

kable_styling(kable(df, caption = 'Summary statistics.', booktabs = TRUE), bootstrap_options = "striped", full_width = FALSE, position = "left")
```
