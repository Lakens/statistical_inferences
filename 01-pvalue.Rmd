...
```{r pdistr1, cache = TRUE, fig.margin=TRUE, echo=FALSE, fig.cap="Distribution of *p*-values when power = 50%."}
...
```{r pdistr2, cache = TRUE, fig.margin=TRUE, echo=FALSE, fig.cap="Distribution of *p*-values when power = 50%."}
...
```{r paradox, fig.margin=TRUE, echo=FALSE, fig.cap="*P*-value distribution for 99% power, where *p*-values just below 0.05 are more likely when H0 is true than when H1 is true"}
