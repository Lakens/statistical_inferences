...
```{r pdistr1, fig.margin=TRUE, echo=FALSE, fig.cap="Distribution of *p*-values when power = 50%."}
...
```{r pdistr2, fig.margin=TRUE, echo=FALSE, fig.cap="Distribution of *p*-values when power = 50%."}
