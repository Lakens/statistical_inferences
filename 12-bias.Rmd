...
```{r carterbias, echo = FALSE, fig.cap="Funnel plot from Carter and McCullough (2014) vizualizing bias in 198 published tests of the ego-depletion effect."}
...
```{r petpeese, echo = FALSE, fig.cap="Funnel plot with PETPEESE regression lines."}
...
```{r petpeeseq4, echo = FALSE, fig.cap="Funnel plot with PETPEESE regression lines for the same studies as in Q2."}
