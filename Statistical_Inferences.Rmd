...
## Sequential Analyses {#sequential}

<!--chapter:end:04-errorcontrol.Rmd-->
...
<!--chapter:end:05-effectsizeCI.Rmd-->
...
<!--chapter:end:06-equivalencetest.Rmd-->
...
<!--chapter:end:11-computationalreproducibility.Rmd-->
