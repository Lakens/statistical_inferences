...
Click the ‘Create SSH Key…’ button. A window will appear, for _SSH key type_ select `ED25519` and optionally add a secure password you won't forget:
...
here](https://medium.com/%40sorenlind/create-pdf-reports-using-r-r-markdown-latex-and-knitr-on-windows-10-952b0c48bfa9)). So leave the default output format to HTML and click OK.
