...
## The Bayesian ROPE proacedure {#ROPE}

In Bayesian estimation, one way to argue for the absence of a meaningful effect is the Region of Practical Equivalence (ROPE) procedure (Kruschke, 2014, chapter 12), which is “somewhat analogous to frequentist equivalence testing” (Kruschke & Liddell, 2017).
...
plotAll(BESTout, credMass=0.9, ROPEm=c(-0.1,0.1), compValm=0.0)
