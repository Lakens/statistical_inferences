...
```{r guesscorrelation, echo=FALSE, fig.cap="Screenshot from Guess the Correlation game (the correct answer is r = 0.24)."}
...
```{r sharedvariance, echo=FALSE, fig.cap="Screenshot from correation effect size vizualization by Kristoffer Magnusson for r - 0.21."}
...
```{r, interactions, echo=F, fig.cap="Schematic illustration of a disordinal (or cross-over) and ordinal interaction"}
...
```{r, interactionplots, eval=T, echo=F, fig.cap="Disordinal (or cross-over) and ordinal interaction with means of 0 and 1, n = 50 per group, and an sd of 2."}
