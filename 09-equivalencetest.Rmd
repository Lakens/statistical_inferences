...
```{r, ciequivalence1, echo = FALSE, fig.cap="The mean difference and its confidence interval for an equivalence test with an equivalence range of -0.5 and 0.5."}
res <- TOSTER::tsum_TOST(m1 = 4.55, m2 = 4.87, sd1 = 1.05, sd2 = 1.11,
...
```{r, ciequivalence2, echo = FALSE, fig.cap="The mean difference and its confidence interval for an equivalence test with an equivalence range of -0.5 and 0.5."}
res <- TOSTER::tsum_TOST(m1 = 4.55, m2 = 4.87, sd1 = 1.05, sd2 = 1.11,
                  n1 = 200, n2 = 200, low_eqbound = -0.5, high_eqbound = 0.5)
...
```{r critf, echo = FALSE, fig.cap="Illustration of the criticial F-value for two groups, 50 observations per group, and an alpha level of 0.05."}
