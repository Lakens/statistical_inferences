...
```{r likelihood1, fig.margin = TRUE, echo = TRUE, fig.cap="Likelihood curve for 8 out of 10 heads in a coin flip."}
...
```{r likelihood2, fig.margin = TRUE, echo = FALSE, fig.cap="Likelihood curve for 0 out of 10 heads in a coin flip."}
# plot likelihood curve----
n <- 10 # set total trials
x <- 0 # set successes
theta <- seq(0, 1, len = 100) # create theta variable, from 0 to 1
...
```{r likelihood3, fig.margin = TRUE, echo = FALSE, fig.cap="Combining likelihood curves."}
...
```{r likelihood4, fig.margin = TRUE, echo = FALSE, fig.cap="Likelihood curves for increasingly large sample sizes."}
...
```{r likelihood5, fig.margin = TRUE, echo = FALSE, fig.cap="Likelihood ratio for 8 out of 10 heads in a coin flip for L($\\theta$ = 0.5) and L($\\theta$ = 0.8)."}
...
```{r likelihood6, fig.margin = TRUE, echo = FALSE, fig.cap="Likelihood ratio for 8 out of 10 heads in a coin flip for L($\\theta$ = 0.5) and L($\\theta$ = 0.8)."}
# Calculate the likelihood ratio----
n <- 10 # set total trials
x <- 4 # set successes
H0 <- .5 # specify one hypothesis you want to compare with the likelihood ratio
...
```{r likelihood7, fig.margin = TRUE, echo = FALSE, fig.cap="Likelihood ratio for 50 out of 100 heads in a coin flip for L($\\theta$ = 0.3) and L($\\theta$ = 0.8)."}
# Calculate the likelihood ratio----
...
```{r bayes4, fig.margin = TRUE, echo = FALSE, fig.cap="Plot for the prior, likelihood, and posterior."}
...
```{r bayes6, fig.margin = TRUE, echo = FALSE, fig.cap="Plot for the prior, likelihood, and posterior."}
...
```{r bayes7, fig.margin = TRUE, echo = FALSE, fig.cap="Plot for the prior, likelihood, and posterior."}
