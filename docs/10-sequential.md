...
\caption{Screenshot of the <a href="https://www.nejm.org/doi/suppl/10.1056/NEJMoa2034577/suppl_file/nejmoa2034577_protocol.pdf">planned interim analyses</a> examining the safety and Efficacy of the BNT162b2 mRNA Covid-19 Vaccine.}(\#fig:interim)
\end{figure}
...
\caption{Plot of critical boundaries at each look for a 2 look design with a Pocock correction.}(\#fig:boundplot1)
\end{figure}
...
\caption{Screenshot of rpact Shiny app.}(\#fig:rpactshiny)
\end{figure}
...
\caption{Four different alpha spending functions (O'Brien-Fleming, Pocock, Haybittle-Peto, Wang-Tsiatis) for 3 looks.}(\#fig:fourspendingfunctions)
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{10-sequential_files/figure-latex/unnamed-chunk-4-1} 

}

\caption{Comparison of Pocock and O'Brien-Fleming correction, and Pocock-like and O'Brien-Fleming like alpha spending function, for 5 looks.}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Power curve for a sequential design with 2 looks.}(\#fig:powerseq)
\end{figure}
...
\caption{Pocock-type boundaries for 3 looks to stop when rejecting $H_0$ (red line) or to stop for futility (blue line) when the observed effect is in the opposite direction.}(\#fig:futility1)
\end{figure}
...
\caption{Pocock-type boundaries for 3 looks to stop when rejecting $H_0$ (red line) or to stop for futility (blue line) based on a Pocock-type beta-spending function.}(\#fig:futility2)
\end{figure}
...
\caption{Power curve for a sequential design with 2 looks with stopping for futility.}(\#fig:powerseq2)
\end{figure}
...
```
## [PROGRESS] Stage results calculated [0.0267 secs] 
## [PROGRESS] Conditional power calculated [0.0222 secs] 
## [PROGRESS] Conditional rejection probabilities (CRP) calculated [0.0009 secs] 
## [PROGRESS] Repeated confidence interval of stage 1 calculated [0.4641 secs] 
## [PROGRESS] Repeated confidence interval of stage 2 calculated [0.4817 secs] 
## [PROGRESS] Repeated confidence interval calculated [0.9468 secs] 
## [PROGRESS] Repeated p-values of stage 1 calculated [0.1809 secs] 
## [PROGRESS] Repeated p-values of stage 2 calculated [0.1869 secs] 
## [PROGRESS] Repeated p-values calculated [0.369 secs] 
...
\caption{Example of O'Brien-Fleming-type boundaries for 3 looks to stop when rejecting $H_0$ (red line) or to stop for futility (blue line) with a 5% Type 1 and Type 2 error.}(\#fig:futilityq13)
\end{figure}
