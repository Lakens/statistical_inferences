...
```
## [PROGRESS] Stage results calculated [0.0804 secs] 
## [PROGRESS] Conditional power calculated [0.099 secs] 
## [PROGRESS] Conditional rejection probabilities (CRP) calculated [0.0037 secs] 
## [PROGRESS] Repeated confidence interval of stage 1 calculated [1.57 secs] 
## [PROGRESS] Repeated confidence interval of stage 2 calculated [1.82 secs] 
## [PROGRESS] Repeated confidence interval calculated [3.39 secs] 
## [PROGRESS] Repeated p-values of stage 1 calculated [1.15 secs] 
## [PROGRESS] Repeated p-values of stage 2 calculated [0.6947 secs] 
## [PROGRESS] Repeated p-values calculated [1.85 secs] 
## [PROGRESS] Final p-value calculated [0.0026 secs] 
## [PROGRESS] Final confidence interval calculated [0.1851 secs]
```
