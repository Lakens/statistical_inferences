...
```
## [PROGRESS] Stage results calculated [0.0538 secs] 
## [PROGRESS] Conditional power calculated [0.0479 secs] 
## [PROGRESS] Conditional rejection probabilities (CRP) calculated [0.0013 secs] 
## [PROGRESS] Repeated confidence interval of stage 1 calculated [0.7605 secs] 
## [PROGRESS] Repeated confidence interval of stage 2 calculated [0.8732 secs] 
## [PROGRESS] Repeated confidence interval calculated [1.63 secs] 
## [PROGRESS] Repeated p-values of stage 1 calculated [0.3122 secs] 
## [PROGRESS] Repeated p-values of stage 2 calculated [0.2933 secs] 
## [PROGRESS] Repeated p-values calculated [0.607 secs] 
## [PROGRESS] Final p-value calculated [0.0027 secs] 
## [PROGRESS] Final confidence interval calculated [0.0773 secs]
```
