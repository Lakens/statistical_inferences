...
## [PROGRESS] Conditional power calculated [0.0322 secs] 
## [PROGRESS] Conditional rejection probabilities (CRP) calculated [0 secs] 
## [PROGRESS] Repeated confidence interval of stage 1 calculated [0.553 secs] 
## [PROGRESS] Repeated confidence interval of stage 2 calculated [0.5946 secs] 
## [PROGRESS] Repeated confidence interval calculated [1.15 secs] 
## [PROGRESS] Repeated p-values of stage 1 calculated [0.2243 secs] 
## [PROGRESS] Repeated p-values of stage 2 calculated [0.2231 secs] 
## [PROGRESS] Repeated p-values calculated [0.4595 secs] 
## [PROGRESS] Final p-value calculated [0 secs] 
## [PROGRESS] Final confidence interval calculated [0.0644 secs]
```
