...
<div class="figure" style="text-align: center">
<img src="10-sequential_files/figure-html/unnamed-chunk-4-1.png" alt="Comparison of Pocock and O'Brien-Fleming correction, and Pocock-like and O'Brien-Fleming like alpha spending function, for 5 looks." width="100%" />
<p class="caption">(\#fig:unnamed-chunk-4)Comparison of Pocock and O'Brien-Fleming correction, and Pocock-like and O'Brien-Fleming like alpha spending function, for 5 looks.</p>
</div>
...
```
## [PROGRESS] Stage results calculated [0.032 secs] 
## [PROGRESS] Conditional power calculated [0.0334 secs] 
...
## [PROGRESS] Repeated confidence interval of stage 2 calculated [0.6502 secs] 
## [PROGRESS] Repeated confidence interval calculated [1.21 secs] 
## [PROGRESS] Repeated p-values of stage 1 calculated [0.2254 secs] 
## [PROGRESS] Repeated p-values of stage 2 calculated [0.226 secs] 
## [PROGRESS] Repeated p-values calculated [0.4528 secs] 
## [PROGRESS] Final p-value calculated [0.0015 secs] 
## [PROGRESS] Final confidence interval calculated [0.0789 secs]
```
