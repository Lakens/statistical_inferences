...
```
## [PROGRESS] Stage results calculated [0.078 secs] 
## [PROGRESS] Conditional power calculated [0.0571 secs] 
## [PROGRESS] Conditional rejection probabilities (CRP) calculated [0 secs] 
## [PROGRESS] Repeated confidence interval of stage 1 calculated [1.28 secs] 
## [PROGRESS] Repeated confidence interval of stage 2 calculated [1.35 secs] 
## [PROGRESS] Repeated confidence interval calculated [2.62 secs] 
## [PROGRESS] Repeated p-values of stage 1 calculated [0.5441 secs] 
## [PROGRESS] Repeated p-values of stage 2 calculated [0.5405 secs] 
## [PROGRESS] Repeated p-values calculated [1.09 secs] 
## [PROGRESS] Final p-value calculated [0.0027 secs] 
## [PROGRESS] Final confidence interval calculated [0.1878 secs]
```
