...
```
## [PROGRESS] Stage results calculated [0.096 secs] 
## [PROGRESS] Conditional power calculated [0.0873 secs] 
## [PROGRESS] Conditional rejection probabilities (CRP) calculated [0.0031 secs] 
## [PROGRESS] Repeated confidence interval of stage 1 calculated [1.53 secs] 
## [PROGRESS] Repeated confidence interval of stage 2 calculated [1.42 secs] 
## [PROGRESS] Repeated confidence interval calculated [2.95 secs] 
## [PROGRESS] Repeated p-values of stage 1 calculated [0.5817 secs] 
## [PROGRESS] Repeated p-values of stage 2 calculated [0.6812 secs] 
## [PROGRESS] Repeated p-values calculated [1.27 secs] 
## [PROGRESS] Final p-value calculated [0.0041 secs] 
## [PROGRESS] Final confidence interval calculated [0.1932 secs]
```
