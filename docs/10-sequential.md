...
```
## [PROGRESS] Stage results calculated [0.0368 secs] 
## [PROGRESS] Conditional power calculated [0.0278 secs] 
## [PROGRESS] Conditional rejection probabilities (CRP) calculated [0.0011 secs] 
## [PROGRESS] Repeated confidence interval of stage 1 calculated [0.5812 secs] 
## [PROGRESS] Repeated confidence interval of stage 2 calculated [0.616 secs] 
## [PROGRESS] Repeated confidence interval calculated [1.2 secs] 
## [PROGRESS] Repeated p-values of stage 1 calculated [0.2412 secs] 
## [PROGRESS] Repeated p-values of stage 2 calculated [0.2372 secs] 
## [PROGRESS] Repeated p-values calculated [0.4795 secs] 
## [PROGRESS] Final p-value calculated [0.0013 secs] 
## [PROGRESS] Final confidence interval calculated [0.0676 secs]
```
