...
```
## [PROGRESS] Stage results calculated [0.0643 secs] 
## [PROGRESS] Conditional power calculated [0.0559 secs] 
## [PROGRESS] Conditional rejection probabilities (CRP) calculated [0.0019 secs] 
## [PROGRESS] Repeated confidence interval of stage 1 calculated [0.8838 secs] 
## [PROGRESS] Repeated confidence interval of stage 2 calculated [0.7461 secs] 
## [PROGRESS] Repeated confidence interval calculated [1.63 secs] 
## [PROGRESS] Repeated p-values of stage 1 calculated [0.3235 secs] 
## [PROGRESS] Repeated p-values of stage 2 calculated [0.2985 secs] 
## [PROGRESS] Repeated p-values calculated [0.6238 secs] 
## [PROGRESS] Final p-value calculated [0.0016 secs] 
## [PROGRESS] Final confidence interval calculated [0.0765 secs]
```
