...
**Q3**: A researcher already knows the sample size they will be able to collect. Given this sample size, they choose to compute equal Type 1 and Type 2 error rates for an effect size of interest. This is know as: 
...
**Q4**: Which two factors contribute to the fact that within subject designs can have much more power, with the same number of participants, than between subject designs? 
...
B) The fact a participant contributes multiple observations, and the correlation between measurements.
C) The fact that responses within participants are more similar than responses between participants, and the correlation between measurements.
D) The fact that responses within participants are more similar than responses between participants, and the fact that effect sizes within individuals are typically larger than effect sizes between individuals.
...
**Q11**: Instead of a post-hoc power analysis, what should researchers do to interpret non-significant results? 
...
**Q12**: What are ways to increase the statistical power of a test, without increasing the sample size? 
