...
\caption{Two-sided null hypothesis test (A), interval hypothesis test (B), equivalence test (C) and minimum effect test (D).}(\#fig:intervaltest)
\end{figure}
...
\caption{The mean difference and its confidence interval plotted below the *t*-distributions used to perform the two-one-sided tests against -0.5 and 0.5.}(\#fig:tdistequivalence)
\end{figure}
...
\caption{The mean difference and its confidence interval for an equivalence test with an equivalence range of -0.5 and 0.5.}(\#fig:ciequivalence1)
\end{figure}
...
\caption{The mean difference and its confidence interval for an equivalence test with an equivalence range of -0.5 and 0.5.}(\#fig:ciequivalence2)
\end{figure}
...
\caption{The mean difference and its confidence interval plotted below the *t*-distributions used to perform the two-one-sided tests against -0.5 and 0.5 when performing a minimum effect test.}(\#fig:tmet)
\end{figure}
...
\caption{Screenshot illustrating a sensitivity power analysis in G*Power to compute the effect size an original study had 33% power to detect.}(\#fig:smalltelpower)
\end{figure}
...
\caption{Example used in Simonsohn 2015 of an original study and two replication studies.}(\#fig:simonsohnexample)
\end{figure}
...
\caption{Null and alternative distribution with Type 1 and Type 2 error indicating the smallest effect size that will be statistically significant with n = 50 per condition.}(\#fig:distpowerplot1)
\end{figure}
...
\caption{Null and alternative distribution with Type 1 and Type 2 error indicating the smallest effect size that will be statistically significant with n = 50 per condition.}(\#fig:distpowerplot2)
\end{figure}
...
\caption{Illustration of the criticial F-value for two groups, 50 observations per group, and an alpha level of 0.05.}(\#fig:critf)
\end{figure}
