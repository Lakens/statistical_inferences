...
<div class="figure" style="text-align: center">
<img src="09-equivalencetest_files/figure-html/ciequivalence1-1.png" alt="The mean difference and its confidence interval for an equivalence test with an equivalence range of -0.5 and 0.5." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="09-equivalencetest_files/figure-html/ciequivalence2-1.png" alt="The mean difference and its confidence interval for an equivalence test with an equivalence range of -0.5 and 0.5." width="100%" />
...
>Results are only valuable when the amount by which they probably differ from the truth is so small its to insignificant for the purposes of the experiment. What the odds selected should he depends-  
