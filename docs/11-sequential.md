...
```
## [PROGRESS] Stage results calculated [0.0588 secs] 
## [PROGRESS] Conditional power calculated [0.0399 secs] 
## [PROGRESS] Conditional rejection probabilities (CRP) calculated [0.001 secs] 
## [PROGRESS] Repeated confidence interval of stage 1 calculated [0.9175 secs] 
## [PROGRESS] Repeated confidence interval of stage 2 calculated [1.37 secs] 
## [PROGRESS] Repeated confidence interval calculated [2.29 secs] 
## [PROGRESS] Repeated p-values of stage 1 calculated [0.4568 secs] 
## [PROGRESS] Repeated p-values of stage 2 calculated [0.4957 secs] 
## [PROGRESS] Repeated p-values calculated [0.9554 secs] 
## [PROGRESS] Final p-value calculated [0.003 secs] 
## [PROGRESS] Final confidence interval calculated [0.1506 secs]
```
