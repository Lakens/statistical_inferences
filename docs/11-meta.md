...
{\centering \includegraphics[width=1\linewidth]{11-meta_files/figure-latex/unnamed-chunk-4-1} 

}

\caption{Simulated studies under a random effects model}(\#fig:unnamed-chunk-4)
\end{figure}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{11-meta_files/figure-latex/unnamed-chunk-5-1} 

}

\caption{Simulated studies under a fixed effect model}(\#fig:unnamed-chunk-5)
\end{figure}
