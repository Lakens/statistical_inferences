...
\caption{(ref:populationlab)}(\#fig:population)
\end{figure}
...
\caption{(ref:cisimlab)}(\#fig:cisim)
\end{figure}
...
\caption{(ref:cioverlaplab)}(\#fig:cioverlap)
\end{figure}
...
\caption{(ref:predictionintervallab)}(\#fig:predictioninterval)
\end{figure}
...
\caption{(ref:metacilab)}(\#fig:metaci)
\end{figure}
...
\caption{(ref:escijamovilab)}(\#fig:escijamovi)
\end{figure}
...
\caption{(ref:jasp1lab)}(\#fig:jasp1)
\end{figure}
...
\caption{(ref:jasp2lab)}(\#fig:jasp2)
\end{figure}
...
\caption{(ref:metaQlab)}(\#fig:metaQ)
\end{figure}
