...
\caption{Example of a registry-based study in which the entire population was included in the study. From https://doi.org/10.1093/ije/dyab066}(\#fig:population)
\end{figure}
...
\caption{Series of simulated point estimates and confidence intervals}(\#fig:cisim)
\end{figure}
...
\caption{Meta-analysis of 4 studies}(\#fig:meta)
\end{figure}
...
\caption{Means and 95% confidence intervals of two independent groups and the mean difference and it's 95% confidence interval.}(\#fig:cioverlap)
\end{figure}
...
\caption{A comparison of a 95% confidence interval (gold) and 95% prediction interval (yellow).}(\#fig:predictioninterval)
\end{figure}
...
\caption{Meta-analysis of 2 simulated studies from the same population.}(\#fig:metaci)
\end{figure}
...
\caption{Output from ESCI module in jamovi.}(\#fig:escijamovi)
\end{figure}
...
\caption{JASP menu option allows you to select Cohen's d and a CI around it.}(\#fig:jasp1)
\end{figure}
...
\caption{JASP output returns Cohen's d and the confidence interval around it.}(\#fig:jasp2)
\end{figure}
...
\caption{Meta-analysis of 4 studies}(\#fig:metaQ)
\end{figure}
