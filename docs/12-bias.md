...
\caption{Funnel plot from Carter & McCullough (2014) vizualizing bias in 198 published tests of the ego-depletion effect.}(\#fig:carterbias)
\end{figure}
...
\caption{Funnel plot with PET_PEESE regression lines.}(\#fig:petpeese)
\end{figure}
...
\caption{Funnel plot with PET_PEESE regression lines for the same studies as in Q2.}(\#fig:petpeeseq4)
\end{figure}
