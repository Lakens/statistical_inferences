...
<img src="06-equivalencetest_files/figure-html/unnamed-chunk-3-1.png" width="100%" style="display: block; margin: auto;" />
...
<img src="06-equivalencetest_files/figure-html/unnamed-chunk-3-2.png" width="100%" style="display: block; margin: auto;" />
...
## effect: HDI width ok 0.9995004995 9.985040e-01 1.000000000
```
...
```
## The required sample size to achieve 87.5 % power with equivalence bounds of -0.5 and 0.5 is 97.66901 per group, or 196 in total.
```
