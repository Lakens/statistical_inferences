...
<img src="03-likelihoods_files/figure-epub3/like1-1.png" alt="Binomial likelihood function for 8 successes in 10 trials." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="03-likelihoods_files/figure-epub3/like2-1.png" alt="Binomial likelihood function for 0 successes in 10 trials." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="03-likelihoods_files/figure-epub3/like3-1.png" alt="Combining likelihoods." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="03-likelihoods_files/figure-epub3/like4-1.png" alt="Likelihood function for 5/10, 50/100 and 500/1000 heads in coin flips." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="03-likelihoods_files/figure-epub3/like5-1.png" alt="Computing a likelihood ratio for *p* = 0.5 relative to *p* = 0.8 when observing *p* = 0.8." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="03-likelihoods_files/figure-epub3/like6-1.png" alt="Computing a likelihood ratio for *p* = 0.5 relative to *p* = 0.8 when observing *p* = 0.4." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="03-likelihoods_files/figure-epub3/like7-1.png" alt="Computing a likelihood ratio for *p* = 0.3 relative to *p* = 0.8 when observing *p* = 0.5 in 100 coin flips." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="03-likelihoods_files/figure-epub3/like8-1.png" alt="Computing a likelihood ratio for 2 out of three significant results, assuming an alpha of 5% and 80% power." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="03-likelihoods_files/figure-epub3/like9-1.png" alt="Likelihood ratio for observed *t*-value under H0 and H1." width="100%" />
