...
## Likelihood of mixed results in sets of studies {#mixedresults}
...
A Shiny app to perform the calculations is available [here](https://shiny.ieis.tue.nl/mixed_results_likelihood/).
