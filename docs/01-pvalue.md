...
<img src="01-pvalue_files/figure-epub3/tdist-1.png" alt="A *t*-distribution with 18 degrees of freedom." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="01-pvalue_files/figure-epub3/pdistr1-1.png" alt="Distribution of *p*-values when power = 50%." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="01-pvalue_files/figure-epub3/pdft-1.png" alt="Probability density function for p-values from a two-sided t-test." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="01-pvalue_files/figure-epub3/pdistr2-1.png" alt="Distribution of *p*-values when power = 50%." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="01-pvalue_files/figure-epub3/paradox-1.png" alt="*P*-value distribution for 0 (grey horizontal line, 50% power (black solid curve), and 99% power (black dotted curve, where *p*-values just below 0.05 are more likely when $H_0$ is true than when $H_1$ is true)." width="100%" />
<p class="caption">(\#fig:paradox)*P*-value distribution for 0 (grey horizontal line, 50% power (black solid curve), and 99% power (black dotted curve, where *p*-values just below 0.05 are more likely when $H_0$ is true than when $H_1$ is true).</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="01-pvalue_files/figure-epub3/fig131-1.png" alt="Distribution of observed Cohen's d effect sizes when collecting 50 observations per group in an independent t-test" width="100%" />
...
<div class="figure" style="text-align: center">
<img src="01-pvalue_files/figure-epub3/fig132-1.png" alt="Distribution of observed Cohen's d effect sizes when collecting 5000 observations per group in an independent t-test when d = 0." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="images/1.3.3.png" alt="Screenshot from G*power software" width="100%" />
<p class="caption">(\#fig:gpower-screenshot)Screenshot from G*power software</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="01-pvalue_files/figure-epub3/fig134-1.png" alt="Distribution of observed Cohen's d effect sizes when collecting 50 observations per group in an independent t-test when d = 0." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="01-pvalue_files/figure-epub3/fig136-1.png" alt="Distribution of observed Cohen's d effect sizes when collecting 50 observations per group in an independent t-test for d = 0 and d = 0.5 when observing d = 0.35." width="100%" />
...
```
##  [1] -0.52917442  0.52589640  0.82312973  0.50545990 -0.17215064 -0.01783938
##  [7]  0.68928444 -1.12829816  2.45781191  0.69391978  0.04840063  0.17111743
## [13]  0.36534453  0.24310565  0.88195046  0.67257273 -0.31950420  0.06040969
## [19]  0.20350633  0.11713629 -0.59883912  0.15699798  0.81162558  0.21137187
## [25] -1.11037594 -0.37363464  0.80299359  1.47369137  0.55188253  0.66260896
## [31]  0.30029705 -0.69545971  0.49322984 -0.31469380 -2.20989371  0.70505709
## [37] -0.59473428  0.36955255  1.37271528  0.03691901  1.12205660  1.13289341
## [43]  0.55519931 -0.26450605 -0.62766082 -2.33883474  0.39405685 -1.45271296
## [49] -0.27603946 -0.14750165
```
...
<div class="figure" style="text-align: center">
<img src="01-pvalue_files/figure-epub3/fig137-1.png" alt="Distribution of observed Cohen's d effect sizes when collecting 50 observations per group in an independent t-test when d = 0 and observing d = 0.5." width="100%" />
...
<div class="figure" style="text-align: center">
<img src="01-pvalue_files/figure-epub3/fig138-1.png" alt="Distribution of observed Cohen's d effect sizes when collecting 20 observations per group in an independent t-test when d = 0." width="100%" />
