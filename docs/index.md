...
If you find any mistakes, or have suggestions for improvement, you can [submit an issue on the GitHub page](https://github.com/Lakens/statistical_inferences/issues) of this open educational resource. As the book is regularly updated, no PDF version is available, but you can print any chapter to PDF by pressing CTRL+P. This work is shared under a [CC-BY-NC-SA License](https://creativecommons.org/licenses/by-nc-sa/4.0). You can cite this resource as:
