...
\caption{Simulated *p*-values for each additional observation when the null is true.}(\#fig:animatep)
\end{figure}
...
\caption{Simulated *p*-values for each additional observation when d = 0.3.}(\#fig:animatep2)
\end{figure}
