...
```{r bayes1, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:bayes1lab)"}
x <- seq(0, 1, 0.001)
...
```{r bayes2, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:bayes2lab)"}
x<-seq(0,1,0.001)
par(mfrow = c(2, 2))
prior <- dbeta(x, 1, 1)
...
```{r bayes4, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:bayes4lab)"}
...
```{r bayes6, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:bayes6lab)"}
...
```{r bayes7, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:bayes7lab)"}
...
```{r bayes8, fig.margin = FALSE, echo = FALSE, fig.cap="(ref:bayes8lab)"}
n <- 20 # set total trials
x <- 10 # set successes
aprior <- 1 # Set the alpha for the Beta distribution for the prior
bprior <- 1 # Set the beta for the Beta distribution for the prior
