...
```{r gpower-screenshot, echo=FALSE, fig.cap="Screenshot of the online calculator for binomially distributed observations"}
...
```{r bayes8, fig.margin = FALSE, echo = FALSE, fig.cap="Plot for the mean of the posterior when 10 out of 20 heads are observed given a uniform prior."}
n <- 20 # set total trials
x <- 10 # set successes
aprior <- 1 # Set the alpha for the Beta distribution for the prior
bprior <- 1 # Set the beta for the Beta distribution for the prior
