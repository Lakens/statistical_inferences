...
```{r, onesidedtwosidedratio, echo = FALSE, fig.cap="Ratio of the required sample size for a one-sample *t*-test for a non-directional/directional test to achieve 50%, 80% or 95% power."}
