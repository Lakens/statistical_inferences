...
```{r meehl1990, echo=FALSE, fig.cap="Distinction between a theoretical hypothesis, a statistical hypothesis, and observations. Figure based on Meehl, 1990."}
...
```{r, onesidedtwosidedratio, echo = FALSE, fig.cap="Ratio of the required sample size for a one-sample *t*-test for a non-directional/direactional test to achieve 50%, 80% or 95% power."}
...
```{r, fandt, echo = FALSE, fig.cap="Distribution and rejection areas for a two-sided t-test and the corresponding F-test with df1 = 1 and df2 = 100."}
df1 <- 1
df2 <- 100
...
<!-- ## The null is never true (except when it is) -->
