...
#| fig-cap: "our different spending functions for 3 looks: O'Brien-Fleming (OF), Pocock (P), Haybittle-Peto (HP), Wang-Tsiatis (WT)."
...
```{r fig-futility2, fig.cap="(ref:futility2lab)"}
