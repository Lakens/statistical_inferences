...
#| fig-cap: "Power curve for an independent *t* test with an effect of *d* = 0.5 and α = 0.05 as a function of the sample size."
...
#| fig-cap: "Null (*d* = 0, grey dashed line) and alternative (*d* = 0.5, solid black line) hypothesis, with α = 0.05 and n = 80 per group."
...
## The Minimal Statistically Detectable Effect {#sec-minimaldetectable}
...
#| fig-cap: "The critical correlation of a test based on a total sample size of 30 and α = 0.05 calculated in G\\*Power."
...
#| fig-cap: "Relationship between *p* values and power for an independent *t* test with α = 0.05 and n = 10."
...
opts_p <- c(
   ...
   answer = "Lower the alpha-level of the test.",
...
6. From all effect sizes that might be related to the inferential goal in a study, which of the 6 categories in @tbl-table-effect-eval is the best approach (if it can be specified)?
