...
```{r, fourspendingfunctions, echo = FALSE, fig.cap="Four different alpha spending functions (O'Brien-Fleming, Pocock, Haybittle-Peto, Wang-Tsiatis) for 3 looks."}
...
```{r, echo = FALSE, fig.cap="Comparison of Pocock and O'Brien-Fleming correction, and Pocock-like and O'Brien-Fleming like alpha spending function, for 5 looks." }
...
```{r powerseq, fig.cap="Power curve for a sequential design with 2 looks." }
...
```{r futility1, echo = FALSE, fig.cap="Pocock-type boundaries for 3 looks to stop when rejecting $H_0$ (red line) or to stop for futility (blue line) when the observed effect is in the opposite direction."}
plot(design)
```
...
```{r futility2, echo = FALSE, fig.cap="Pocock-type boundaries for 3 looks to stop when rejecting $H_0$ (red line) or to stop for futility (blue line) based on a Pocock-type beta-spending function."}
...
```{r powerseq2, echo = FALSE, fig.cap="Power curve for a sequential design with 2 looks with stopping for futility."}
sample_res <- getPowerMeans(
  design = seq_design,
  groups = 2,
  alternative = seq(0,1,0.01), 
...
```{r, futilityq13, echo = FALSE, fig.cap="Example of O'Brien-Fleming-type boundaries for 3 looks to stop when rejecting $H_0$ (red line) or to stop for futility (blue line) with a 5% Type 1 and Type 2 error."}
